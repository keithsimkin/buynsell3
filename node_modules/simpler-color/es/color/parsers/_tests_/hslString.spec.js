...
describe('isHslString', () => {
  const valid = ['hsl(240, 100%, 50%)', 'hsl(240, 100%, 50%, 0.1)', 'hsl(240, 100%, 50%, 10%)', 'hsl(240,100%,50%,0.1)', 'hsl(180deg, 100%, 50%, 0.1)', 'hsl(3.14rad, 100%, 50%, 0.1)', 'hsl(200grad, 100%, 50%, 0.1)', 'hsl(0.5turn, 100%, 50%, 0.1)', 'hsl(480, 100.5%, -50%, 10)', 'hsl(240 100% 50%)', 'hsl(240 100% 50% / 0.1)', 'hsl(240 100% 50% / 10%)', 'hsl(240deg 100% 50% / 0.1)', 'hsl(240 100% 50%/0.1)', 'hsla(240, 100%, 50%)', 'hsla(240, 100%, 50%, 0.1)', 'HSL(240Deg, 100%, 50%)'];
  valid.forEach(str => {
    it(`returns true for valid hsl string: ${str}`, () => {
      expect(isHslString(str)).toBe(true);
    });
  });
  const invalid = ['rgb(127, 255, 255)', '#88FFFF', 'blue', 'hsl(240, 1, 0.5, 0.1)', ' hsl(240, 100%, 50%, 0.1) ', 'hsl(240 100% 50% 0.1)', 'rainbow'];
  invalid.forEach(str => {
